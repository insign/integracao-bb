...
class Cobranca
{
  ...
  // Reutiliza token em cache se ainda válido, evitando chamadas desnecessárias à API OAuth
  ...
  public function registrarBoleto(array $campos): stdClass
  {
    $response = $this->getHttpClient()->post(
      ...
      options: [
                 ...
                 "json"    => $campos,
                 "query"   => ["gw-dev-app-key" => $this->developerKey],
               ]
    );
  ...
  public function verBoleto(int|string $id, int|string $convenio): stdClass
  {
    $response = $this->getHttpClient()->get(
      ...
      [
        "headers" => $this->getAuthHeaders(),
        "query"   => [
          "gw-dev-app-key" => $this->developerKey,
